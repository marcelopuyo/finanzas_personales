...
// Nombres de las tarjetas/cuentas SINTÉTICAS del dashboard ("Por cobrar" y
// "Actuales"). No son cuentas reales (se calculan en dashboard-data.ts) y
// NUNCA deben ofrecerse en los selects de cuenta del stepper. Si en el futuro
// se crearan cuentas con estos nombres, quedan excluidas aquí (garantía
// defensiva; hoy no existen en la BD).
